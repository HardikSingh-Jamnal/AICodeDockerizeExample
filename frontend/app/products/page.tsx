        ...
        <form onSubmit={handleSubmit} style={{ marginBottom: '30px', padding: '20px', border: '1px solid #ddd', borderRadius: '5px' }}>
          ...
          <div style={{ marginBottom: '15px' }}>
            ...
            <textarea
              ...
              style={{ width: '100%', padding: '8px', marginTop: '5px', border: '1px solid #ddd', borderRadius: '3px', minHeight: '60px' }}
            />
          </div>
          ...
          <div>
            ...
            <button type="button" onClick={resetForm} style={{ padding: '10px 20px', backgroundColor: '#6c757d', color: 'white', border: 'none', borderRadius: '5px', cursor: 'pointer' }}>
              Cancel
            </button>
          </div>
        </form>
              ...
              <div key={product.id} style={{ border: '1px solid #ddd', borderRadius: '5px', padding: '15px' }}>
                ...
                <div style={{ marginTop: '10px' }}>
                  <button 
                    ...
                    style={{ padding: '5px 10px', backgroundColor: '#ffc107', color: 'black', border: 'none', borderRadius: '3px', cursor: 'pointer', marginRight: '5px' }}
                  >
                    Edit
                  </button>
                  <button 
